...
<div class="receipts index">
    ...
    <tr>
    	<th><?php echo $paginator->sort('Entrada No.','id');?></th>
    ...
    ?>
    	<tr<?php echo $class;?>>
    		<td>
    			<?php 
                    echo $html->link(__($receipt['Receipt']['id'], true), array('action' => 'view', $receipt['Receipt']['id'])); 
                ?>
    		</td>
    		<td>
    			<?php 
                    echo $html->link(__($receipt['Receipt']['created'], true), array('action' => 'view', $receipt['Receipt']['id'])); 
                ?>
    		</td>
    	</tr>
    <?php endforeach; ?>
